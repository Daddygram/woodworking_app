...
const About2 = () => {
  return (
    <section className='max-container flexCenter mt-[200px] relative banner'>
        <div className='w-[700px] absolute top-[-50px] left-0'>
            <Image src={"/furniture-banner-withfloor.png"} alt='furniture' width={800} height={800} />
        </div>
        <div className='w-full p-20 flex flex-col'>
            <p className='text-gray-10 pt-4 pb-4 regular-16 max-w-[500px] text-center self-end'>Welcome to our website, where craftsmanship meets innovation. <span className='bold-16'>Our experience starts from 1998</span>. 
